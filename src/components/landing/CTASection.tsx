  ...
  return (
    <section className="py-24 bg-gray-950 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full bg-brand-pink/10 blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full bg-brand-purple/10 blur-3xl" />
      </div>
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <h2 className="font-display font-bold text-4xl sm:text-5xl text-white mb-6 leading-tight">
          ...
          <span className="bg-gradient-to-r from-brand-pink to-brand-purple bg-clip-text text-transparent">today, for free</span>
        </h2>
        ...
        <p className="text-gray-600 text-sm mt-4">No credit card required. Free plan available.</p>
      </div>
    </section>
  );
}
